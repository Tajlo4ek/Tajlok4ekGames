...
namespace Editor.MyControl.DataControl
{
    ...
    /// </summary>
    public partial class VideoControl : UserControl, IData
    {
        ...
        public VideoControl(PackManager packManager)
        {
            InitializeComponent();
        ...
        public Scenario GetData()
        {
            ...
            return new Scenario((isLocal ? "@" : "") + path, Scenario.ScenarioType.Video, time);
        }
